...
(function (factory) {
    ...
    return moment.defineLocale('az', {
        ...
        weekdays : "Bazar_Bazar ert?si_Ç?r??nb? ax?amı_Ç?r??nb?_Cüm? ax?amı_Cüm?_??nb?".split("_"),
...
(function (factory) {
    ...
    return moment.defineLocale('cs', {
        ...
        weekdays : "ned?le_pond?lí_úter?_st?eda_?tvrtek_pátek_sobota".split("_"),
...
(function (factory) {
    ...
    return moment.defineLocale('el', {
        monthsNominativeEl : "??????????_???????????_???????_?π??????_?????_???????_???????_?????????_??π????????_?????????_?????????_??????????".split("_"),
        monthsGenitiveEl : "??????????_???????????_???????_?π??????_?????_???????_???????_?????????_??π????????_?????????_?????????_??????????".split("_"),
        ...
        monthsShort : "???_???_???_?π?_???_????_????_???_??π_???_???_???".split("_"),
        weekdays : "???????_???????_?????_???????_???π??_?????????_???????".split("_"),
        weekdaysShort : "???_???_???_???_???_???_???".split("_"),
        weekdaysMin : "??_??_??_??_??_??_??".split("_"),
        meridiem : function (hours, minutes, isLower) {
            if (hours > 11) {
...
(function (factory) {
    ...
    return moment.defineLocale('fo', {
        ...
        weekdays : "sunnudagur_mánadagur_t?sdagur_mikudagur_hósdagur_fríggjadagur_leygardagur".split("_"),
        weekdaysShort : "sun_mán_t?s_mik_hós_frí_ley".split("_"),
        weekdaysMin : "su_má_t?_mi_hó_fr_le".split("_"),
        longDateFormat : {
            LT : "HH:mm",
            L : "DD/MM/YYYY",
            LL : "D MMMM YYYY",
...
// moment.js locale configuration
// locale : icelandic (is)
// author : Hinrik Örn Sigur?sson : https://github.com/hinrik
...
(function (factory) {
    ...
    return moment.defineLocale('tr', {
        months : "Ocak_?ubat_Mart_Nisan_Mayıs_Haziran_Temmuz_A?ustos_Eylül_Ekim_Kasım_Aralık".split("_"),
        monthsShort : "Oca_?ub_Mar_Nis_May_Haz_Tem_A?u_Eyl_Eki_Kas_Ara".split("_"),
        weekdays : "Pazar_Pazartesi_Salı_Çar?amba_Per?embe_Cuma_Cumartesi".split("_"),
